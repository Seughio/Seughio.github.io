...
![卡诺逆循环](assets/figures/fig-13-卡诺逆循环.png){ .fig-small}
...
![空气制冷循环装置](assets/figures/fig-13-空气.png){ .fig-small}

![空气制冷循环图](assets/figures/fig-13-空冷.png){ .fig-small}
...
![蒸汽压缩制冷循环](assets/figures/fig-13-蒸气制冷循环.jpg){ .fig-medium}
