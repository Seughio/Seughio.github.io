...
![布雷顿循环](assets/figures/fig-12-布雷顿循环.png){ .fig-medium}
...
![考虑摩擦](assets/figures/fig-12-考虑摩擦.png){ .fig-small}
...
1. 内燃机工作基本原理
    ...
    ![内燃机工作原理](assets/figures/fig-12-内燃机.png){ .fig-small}
...
2. 三类理想循环
    ...
    ![混合加热理想循环](assets/figures/fig-12-混合.png){ .fig-medium}
    ...
    ![定容](assets/figures/fig-12-定容.png){ .fig-medium}

    $$\eta _{t,v}=1-\frac{1}{\varepsilon ^{\gamma -1}}$$

    (3) 定压加热理想循环（狄赛尔循环）

    ![定压](assets/figures/fig-12-定压.png){ .fig-medium}
